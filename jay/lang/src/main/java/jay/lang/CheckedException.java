...
/**
 * This class represents a checked exception. The difference from standard <code>java.lang.Exception</code> is
 ...
 * @see FaultDefinition
 */
public class CheckedException extends Exception implements IException {
    ...
    /**
     * Constructs a new checked exception with {@link FaultCode#UNKNOWN} and {@link Severity#UNKNOWN}.
     * 
    ...
    /**
     * Constructs a new checked exception with a given message, {@link FaultCode#UNKNOWN} and {@link Severity#UNKNOWN}.
     * 
     * In this case, the value returned by {@link #getFault()} will be null.
     * 
    ...
    /**
     * Constructs a new checked exception with a given cause, {@link FaultCode#UNKNOWN} and {@link Severity#UNKNOWN}.
     * 
    ...
    /**
     * Constructs a new checked exception with a given message, cause, {@link FaultCode#UNKNOWN} and {@link Severity#UNKNOWN}.
     * 
     * @param message The message to be associated to the exception instance.
     * @param cause The cause to be associated to the exception instance.
     */
    ...
    /**
     * Constructs a new checked exception with a given faultCode. 
     *
     ...
     */
    public CheckedException(IFaultCode faultCode, Object... messageArgs) {
        this(faultCode, null, null, messageArgs);
    }

    /**
     * Constructs a new checked exception with a given faultCode and locale. 
     * 
     * If the faultCode is null, then {@link FaultCode#UNKNOWN} will be used and the value returned by 
     * {@link #getFault()} will be null.
     * 
     ...
     * @param messageArgs The arguments to be used while formatting the fault message.
     */
    public CheckedException(IFaultCode faultCode, Locale locale, Object... messageArgs) {
        this(faultCode, null, locale, messageArgs);
    }

    /**
     * Constructs a new checked exception with a given faultCode and severity. 
     * 
     * If the faultCode is null, then {@link FaultCode#UNKNOWN} will be used and the value returned by 
     * {@link #getFault()} will be null.
     * 
     ...
     * @param messageArgs The arguments to be used while formatting the fault message.
     */
    public CheckedException(IFaultCode faultCode, ISeverity severity,
            Object... messageArgs) {
        this(faultCode, severity, null, messageArgs);
    }

    /**
     * Constructs a new checked exception with a given faultCode, severity and locale.
     * 
     * If the faultCode is null, then {@link FaultCode#UNKNOWN} will be used and the value returned by 
     * {@link #getFault()} will be null.
     * 
    ...
    /**
     * Constructs a new checked exception with a given cause and faultCode.
     * 
     ...
     * @param messageArgs The arguments to be used while formatting the fault message.
     */
    public CheckedException(Throwable cause, IFaultCode faultCode, Object... messageArgs) {
        this(cause, faultCode, null, null, messageArgs);
    }
    
    /**
     * Constructs a new checked exception with a given cause, faultCode and locale.
     *
     * If the cause is null, it will be considered that there is no cause and the value returned by
     * {@link #getCause()} will be null as well.
     * 
     ...
     * @param messageArgs The arguments to be used while formatting the fault message.
     */
    public CheckedException(Throwable cause, IFaultCode faultCode, Locale locale, Object... messageArgs) {
        this(cause, faultCode, null, locale, messageArgs);
    }    
    
    /**
     * Constructs a new checked exception with a given cause, faultCode and severity.
     * 
     * If the cause is null, it will be considered that there is no cause and the value returned by
     * {@link #getCause()} will be null as well.
     * 
     ...
     * @param messageArgs The arguments to be used while formatting the fault message.
     */
    public CheckedException(Throwable cause, IFaultCode faultCode,
            ISeverity severity, Object... messageArgs) {
        this(cause, faultCode, severity, null, messageArgs);
    }
    
    /**
     * Constructs a new checked exception with a given cause, faultCode, severity and locale.
     * 
     * If the cause is null, it will be considered that there is no cause and the value returned by
     * {@link #getCause()} will be null as well.
     * 
